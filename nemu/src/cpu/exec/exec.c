...
make_group(group1_b,
	...
	and_i2rm_b, sub_i2rm_b, xor_i2rm_b, inv)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, 
	and_i2rm_v, sub_i2rm_v, xor_i2rm_v, inv)
...
/* 0xc0 */	group2_i_b, group2_i_v, inv, ret_n_v,
